...
SimTime   = 300                             # Total simulation time (fs)               
dtN       = 20.0                             # bath time step (au)
...
δε        = torch.zeros(NMol) * eV2au          # exciton energy inhomogenity     
...
b_np = np.array([evalCheb(i) for i in range(numChebTerms+1)])
